              ...
              <div className={`diagnosis-card table-card ${showResult ? "diagnosis-card--visible" : ""}`}>
                {result.lowConfidence && (
                  <div className="diagnosis-warning">
                    ...
                    <span>
                      <strong>Low Confidence Result:</strong> This analysis is based on limited patterns. For a more reliable diagnosis, please ensure the photo is clear and well-lit.
                    </span>
                  </div>
                )}
